...
def manager_message_generator(mock_sendall, memory_profiler, tmp_path):
    ...
    yield json.dumps({
        ...
        "input_paths": [
            TESTDATA_DIR/"input_large_intermediate/file01",
            TESTDATA_DIR/"input_large_intermediate/file02",
            TESTDATA_DIR/"input_large_intermediate/file03",
            TESTDATA_DIR/"input_large_intermediate/file04",
        ],
